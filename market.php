            ...
            <div class=" p-6 space-y-3">
               ...
               <div class="grid grid-cols-3 gap-4">
                ...
                <div class="checkbox">
                    ...
                    <label for="chekcbox1"><span class="checkbox-icon"></span> I agree to the <a href="pages-terms.php" target="_blank" class="uk-text-bold uk-text-small uk-link-reset"> Terms and Conditions </a>
                    </label>
                </div>
