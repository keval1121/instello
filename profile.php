                ...
                <div class="flex lg:flex-row flex-col items-center lg:py-8 lg:space-x-8">
                    ...
                    <div>
                        <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-1 rounded-full m-0.5 mr-2  w-56 h-56 relative overflow-hidden uk-transition-toggle">  
                            <img src="profile_img/<?php echo $login_user_data['image']; ?>" class="bg-gray-200 border-4 border-white rounded-full w-full h-full dark:border-gray-900">
                    ...
                    <div class="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center"> 
                        ...
                        <h2 class="font-semibold lg:text-2xl text-lg mb-2"> <?php echo $login_user_data['first_name']; ?>&nbsp;<?php echo $login_user_data['last_name']; ?></h2>
