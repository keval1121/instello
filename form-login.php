<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        $check_user = "select * from registration where email='$email' and password='$pass'";
        ...
        <div>
            <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
                ...
                <form method="POST">
                    ...
                    <input type="text" name="pass" placeholder="***********" class="bg-gray-200 mb-2 shadow-none dark:bg-gray-800" style="border: 1px solid #d3d5d8 !important;">
                    ...
                    <button type="submit" name="login" class="bg-gradient-to-br from-pink-500 py-3 rounded-md text-white text-xl to-red-400 w-full">Login</button>
