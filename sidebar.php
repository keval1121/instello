            ...
            <div class="sidebar_inner" data-simplebar>
                <div class="flex flex-col items-center my-6 uk-visible@s">
                    <div
                        ...
                        <img src="profile_img/<?php echo $get_user['image']; ?>"
                            class="bg-gray-200 border-4 border-white rounded-full w-full h-full">
                    </div>
                    <a href="profile.php" class="text-xl font-medium capitalize mt-4 uk-link-reset"> <?php echo $get_user['first_name']; ?>  <?php echo $get_user['last_name']; ?>
                    </a>
